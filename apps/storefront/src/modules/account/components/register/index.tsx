  ...
  return (
    ...
    >
      <h1 className="text-large-semi uppercase mb-6">
        Menjadi Anggota Medusa Store
      </h1>
      <p className="text-center text-base-regular text-ui-fg-base mb-4">
        Buat profil Anggota Medusa Store dan dapatkan akses ke pengalaman
      ...
      {message?.state === "verification_required" && (
        ...
        >
          ...
          <strong>{message.email}</strong>. Silakan periksa kotak masuk Anda
          untuk memverifikasi email, lalu masuk.
        </div>
      )}
